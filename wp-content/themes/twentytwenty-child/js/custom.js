window.addEventListener("scroll", function() {
    ...
    var elementTargetPosition = document.getElementsByClassName("post-inner");
    var elementTarget = document.getElementById("sideAd");

    if (window.scrollY > elementTargetPosition[0].offsetTop) {
        elementTarget.style.position = "fixed";
    } else if (window.scrollY < elementTargetPosition[0].offsetTop) {
        elementTarget.style.position = "absolute";
    }
});
